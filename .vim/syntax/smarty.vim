...
syn keyword smartyTagName insert if elseif else "/if" ldelim rdelim literal "/literal"
syn keyword smartyTagName php /php section sectionelse /section foreach foreachelse /foreach
syn keyword smartyTagName strip /strip cycle config_load assign counter debug
syn keyword smartyTagName eval /eval fetch html_checkboxes html_image
...
syn region smartyStringDouble matchgroup=Constant start=+"+  end=+"+  contains=smartyMaybeVariable, smartyInBacktick, smartyMaybeDollarSign, smartyZone contained
